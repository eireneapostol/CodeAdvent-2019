...
wire1 = set(create_wire(wire1_init))
wire2 = set(create_wire(wire2_init))

intersections = list(wire1.intersection(wire2))

minim = manhattan_distance(intersections[0], (0,0))

for n in intersections:
    if manhattan_distance(n, (0,0)) < minim and manhattan_distance(n, (0,0)) != 0:
        minim = manhattan_distance(n, (0,0))
